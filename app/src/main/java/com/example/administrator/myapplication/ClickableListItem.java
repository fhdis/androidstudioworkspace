...
public class ClickableListItem extends LinearLayout {
    ...
    public ClickableListItem(Context context, AttributeSet attrs, int defStyle) {
        ...
        //iconSrc = a.getResourceId(R.styleable.ClickableListItem_imgsrc, R.drawable.ic_launcher);
        iconSrc = a.getResourceId(R.styleable.ClickableListItem_imgsrc, R.mipmap.ic_menu_right);

        textColor = a.getColor(R.styleable.ClickableListItem_textColor, getResources().getColor(R.color.gray));
    ...
    private void init() {
        ...
        iv.setImageDrawable(getResources().getDrawable(R.mipmap.ic_menu_right));
        //
